...
const GaleriesEditScoop = Vue.component('GaleriesEditComponent', require('./components/pages/galeries/Galeries-edit'));
...
const routes = [
    ...
    { path: '/admin/creator/edit/:id', component: CreatorScoop },
